    ...
    return (
        ...
        <div style={{ display: "flex", height: "100vh" }}>
            ...
            <div className="bg-white p-[50px] ">
                <p className="mt-15 text-4xl font-semibold text-sky-600 flex items-center gap-2 mb-5">
                ...
                <form className="space-y-6 ">
                    ...
                    {step === 3 && (
                        <>
                            <EnterNewPasswordStep formData={formData} />
                            <div className="flex justify-between">
                                <Button onClick={() => setStep(4)}>Trở về</Button>
                                <Button
                                //onClick={handleAddNewScholarshipProgram}
                                >
                                    Tạo sản phẩm
                                </Button>
                            </div>
